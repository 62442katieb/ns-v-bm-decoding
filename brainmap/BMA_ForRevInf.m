function SigMetaData = BMA_ForRevInf(someexps)
...
for count2 = 1:numel(someexps)
    ...
    for count = 1:8 % Change to 1:8 for all Metadata fields
        switch count
            case 1
                AllTask = AllBD;
        ...
        clear AllTask TaskAvail TaskExps taskp PAct a ans b c finalexps run sumcoords temptask

        FinForInf(:,1) = ForInf(:,1);
